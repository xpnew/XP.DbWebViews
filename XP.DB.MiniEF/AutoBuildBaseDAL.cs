...
namespace XP.DB.MiniEF
{
        ...
        where T : class,new()
    {
        ...
        protected virtual void Init()
        {
            ...
            TableName = InnerType.Name;

            _PropertyValueGeter = new DynamicMethod<T>();

            object[] attrsAllows = InnerType.GetCustomAttributes(typeof(System.Data.Linq.Mapping.TableAttribute), true);
            if (0<attrsAllows.Length)
            {
                foreach (var item in attrsAllows)
                {
                    System.Data.Linq.Mapping.TableAttribute attr = item as System.Data.Linq.Mapping.TableAttribute;
        ...
        /// <summary>
        /// 构造 一个 静态的方法，使用起来比较麻烦。。。。
        /// </summary>
        /// <typeparam name="TAutoDal"></typeparam>
        /// <typeparam name="TEntity"></typeparam>
        /// <param name="provider"></param>
        /// <returns></returns>
        //public static TAutoDal CreateInstance<TAutoDal, TEntity>(IProvider provider) where TAutoDal : AutoBuildBaseDAL<TEntity>, new()
        //{
        //    TAutoDal Result = new TAutoDal();
        ...
        protected List<T> ConextRun(string sql)
        {
            ...
            try
            {
                ...
                IEnumerable collections = dataContext.ExecuteQuery<T>(sql);
        ...
        {
            string SqlWhere = " Id IN ( " + String.Join(",", idList) + ")";
            return DeleteModel(SqlWhere); ;
        }
        ...
        public string MkDeleteSql(string idString)
        {
